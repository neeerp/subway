...
mkdir -p build/home build/station build/static build/bundles
...
echo "Bundling files..."
zip build/bundles/home.zip -j ./build/home/bootstrap
zip build/bundles/station.zip -j ./build/station/bootstrap
